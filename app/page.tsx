...
ASOGFLUX는 빠르게 이해되고, 자연스럽게 이동하며, 망설임 없이 선택하게 작동하는 경험을 목표로 합니다. 결과물은 아름답고, 과정은 명확해야 한다고 믿습니다.
            ...
            <p className="mt-8 text-sm italic text-black/60">Sidenote</p>
            <p className="mt-2 text-lg text-black/80">
            Design is not just what it looks like, but how it flows.            </p>
          </div>
        </section>
        ...
        <section id="studio" className="flex w-full justify-end border-t border-black/10 py-20">
          <div className={`${CONTENT_MAX} ${CONTENT_PADDING} w-full max-w-full min-[1920px]:max-w-[60vw] text-left`}>
            ...
            <p className="mt-8 text-sm italic text-black/60">Sidenote</p>
            <p className="mt-2 text-lg text-black/80">
              Design is not just what it looks like, but how it flows.
            </p>
          </div>
        </section>
...
ASOGFLUX는 빠르게 이해되고, 자연스럽게 이동하며, 망설임 없이 선택하게 작동하는 경험을 목표로 합니다. 결과물은 아름답고, 과정은 명확해야 한다고 믿습니다.
            ...
            <p className="mt-8 text-left text-sm italic text-black/60">Sidenote</p>
            <p className="mt-2 text-left text-lg text-black/80">
            Design is not just what it looks like, but how it flows.            </p>
          </div>
        </section>

        {/* let's talk*/}
        <section id="let's talk" className="w-full border-t border-black/10 py-6">
